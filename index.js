...
function showCurrentWeather(data){
   ...
   const selectedIcon = findRelatedIcon(data.WeatherIcon)
    ...
    showFollowingDaysWeather(sampleData)
...
function fetchFollowingDaysWeather(locationKey){
    ...
    .then(json => {
        ...
        //let followingDaysData = json.DailyForecasts



    })
}
    const locationKeyToWork = 318290
    //fetchFollowingDaysWeather(locationKeyToWork)
...
// --------------------------------------------------------------------------
    //will be deleted after its done
    let sampleData = myObjFollowingDays
